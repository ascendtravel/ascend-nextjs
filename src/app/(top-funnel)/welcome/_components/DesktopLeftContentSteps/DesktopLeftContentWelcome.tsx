...
export default function DesktopLeftContentWelcome() {
    ...
    return (
        <motion.div
            className='relative z-10 flex w-1/2 items-center justify-center overflow-x-hidden rounded-r-2xl bg-gradient-to-b from-[#0B74C0] to-[#57A3D9] py-8 pl-12'
            ...
            <div className='-mr-6 flex h-full w-full flex-col justify-between gap-4 overflow-y-auto pb-4 pl-8'>
                ...
                <div className='flex flex-col items-start justify-center gap-4'>
                    ...
                    <div className='my-4 -ml-4 flex flex-col items-start justify-center gap-2 text-white'>
                        {cyclingStepsData.map((step, index) => (
                            <motion.div
                                ...
                                <div className='size-6'>{step.icon}</div>
                                <div>{step.text}</div>
                            </motion.div>
                        ))}
                    </div>
