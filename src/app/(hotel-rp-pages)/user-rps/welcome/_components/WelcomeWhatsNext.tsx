...
export function WelcomeWhatsNext({ componenHeader, rowsInfo }: WelcomeWhatsNextProps) {
    return (
        <div className='flex max-w-md flex-col gap-2 px-6 pb-4'>
            ...
            <div className='mt-4 flex flex-col'>
                {rowsInfo.map((row, index) => (
                    <React.Fragment key={row.content}>
                        <div className='my-2 flex flex-row items-center gap-2 rounded-2xl border border-neutral-100 py-2 pr-4 shadow-sm'>
