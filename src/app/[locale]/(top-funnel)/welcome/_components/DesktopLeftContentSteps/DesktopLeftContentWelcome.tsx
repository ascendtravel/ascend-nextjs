...
const cyclingStepsData = [
    {
        id: 'email',
        icon: '📧',
        text: 'steps.connectGmail.title',
        subtext: 'steps.connectGmail.description',
    },
    {
        id: 'phone',
        icon: '☎️',
        text: 'steps.verifyPhone.title',
        subtext: 'steps.verifyPhone.description',
    },
    {
        id: 'member',
        icon: '🎉',
        text: 'steps.becomeMember.title',
        subtext: 'steps.becomeMember.description',
    }
];
